...
public class GetDirectActivitySummaryRouteHandler extends RouteHandler {

	public GetDirectActivitySummaryRouteHandler() {
	...
	public DataModel process(HashMap<String, String> param) {
		...
		try {
			User user = new User();
			j = user.getUsersSummaryOfDirectActivity(projectId, dateFrom , dateTo);
